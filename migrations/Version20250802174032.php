 ...
 */
final class Version20250802174032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id SERIAL NOT NULL, user_id INT NOT NULL, label VARCHAR(255) NOT NULL, transaction_date DATE NOT NULL, amount NUMERIC(10, 2) NOT NULL, info TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
